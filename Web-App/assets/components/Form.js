        ...
        <div className='div-container'>
            <div className="form-container">
                <div className='div-child toggle-button'>
                    <input type='checkbox' id='toggle' className='toggleCheckbox input' value='report' />
                ...
                <div className='div-child formular'>
                    <form method='post' action=''>
                        ...
                        <input name='Name' className='input' type="text" id="fname" required='true' >

                        </input>
                        <label htmlFor="fmail">Email*</label>
                        <input name='Mail' className='input' type="email" id="fmail" required='true' >

                        </input>
                        <label>Game*</label>
                        <select name='Game' className='select'>
                            <option value='game1'>Game1</option>
                            <option value='game2'>Game2</option>
                            <option value='game3'>Game3</option>
                        </select>
                        <label>Category*</label>
                        <select name='Categ' className='select'>
                            <option value='categ1'>Categ1</option>
                            <option value='categ2'>Categ2</option>
                            <option value='categ3'>Categ3</option>
                        </select>
                        <label>Description</label>
                        <textarea name='Msg' className='textarea' cols='5' rows='5' placeholder='Write your message here...'>
